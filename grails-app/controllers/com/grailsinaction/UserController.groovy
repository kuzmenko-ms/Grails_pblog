...
class UserController {
    ...
    static navigation = [
            [group:'tabs', action:'search',title: 'Поиск',  order: 90],
        [action: 'advSearch', title: 'Расширенный поиск', order: 95],
        [action: 'register', title: 'Регистрация', order: 99, isVisible: { !springSecurityService.isLoggedIn() }]
    ]
